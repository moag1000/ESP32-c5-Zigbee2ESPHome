...
/**
 * @brief Set Fingerbot click control enable/disable (DP 108)
 *
 * Enables or disables the physical button on Fingerbot Plus.
 * Only available on _TZ3210_j4pdtz9v variant.
 *
 * @param[in] short_addr Device short address
 * @param[in] endpoint Target endpoint
 * @param[in] enable true to enable click control, false to disable
 * @return ESP_OK on success
 */
