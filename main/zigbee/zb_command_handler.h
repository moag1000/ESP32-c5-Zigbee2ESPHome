...
#ifndef ZB_COMMAND_HANDLER_H
#define ZB_COMMAND_HANDLER_H
...
/**
 * @brief Send Color Temperature command to device
 *
 * Sends ZCL Color Control "Move to Color Temperature" command (mireds).
 *
 * @param[in] short_addr Device short address
 * @param[in] endpoint Device endpoint
 * @param[in] color_temp_mireds Color temperature in mireds (153-500 typical)
 * @param[in] transition_time Transition time in 1/10 seconds (0 = instant)
 * @return ESP_OK on success
 */
