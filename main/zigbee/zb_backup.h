 ...
 * - LittleFS-based backup storage with versioning and timestamps
 ...
 */
#define ZB_BACKUP_FILE_PATH             "/littlefs/backup"
 ...
 * It is serialized to LittleFS for persistent storage.
 */
typedef struct {
    /* Header */
 ...
 *
 * Initializes the backup module, mounts LittleFS partition if needed,
...
/**
 * @brief Save backup to LittleFS
 *
 * Serializes and saves the backup data to LittleFS storage.
...
/**
 * @brief Load backup from LittleFS
 *
 * Loads and deserializes backup data from LittleFS storage.
 *
 ...
 *
 * Removes a backup file from LittleFS storage.
 *
