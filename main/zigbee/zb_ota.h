 ...
 * - Image storage in LittleFS partition
...
/**
 * @brief LittleFS mount point for OTA images
 */
#define ZB_OTA_LITTLEFS_MOUNT_POINT             "/ota_storage"
...
typedef struct {
    ...
    char file_path[64];                          /**< Path to image file in LittleFS */
