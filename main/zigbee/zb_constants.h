...
/** @brief Gap between provisioning retry rounds */
#define ZB_REPORTING_PROVISION_RETRY_MS         60000
...
/** @brief Electrical measurement voltage divisor (V * 10) */
#define ZB_ELECTRICAL_VOLTAGE_DIVISOR           10

/** @brief Electrical measurement current divisor (milliamps to amps) */
#define ZB_ELECTRICAL_CURRENT_DIVISOR_MA        1000

/** @brief Electrical measurement power divisor (W * 10) */
#define ZB_ELECTRICAL_POWER_DIVISOR             10
