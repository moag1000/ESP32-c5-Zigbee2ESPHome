...
/** @brief Default LED effect timer period in microseconds (200ms - slower for single-core) */
#ifndef LED_EFFECT_DEFAULT_PERIOD_US
#define LED_EFFECT_DEFAULT_PERIOD_US        200000
#endif

/** @brief Minimum strobe effect period in microseconds (10ms) */
#ifndef LED_STROBE_MIN_PERIOD_US
 ...
 */
typedef enum {
    LED_NOTIFY_DEVICE_NEW,      /**< New device joined - 1x red blink */
