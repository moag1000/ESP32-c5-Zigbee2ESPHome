...
static const char CAPTIVE_PORTAL_HTML[] =
    ...
    ".opt{color:#888;font-weight:400}"
    ".hint{color:#666;font-size:.78em;margin:-4px 0 10px}"
    ...
    "</div>"
    "<label for='k'>Home Assistant encryption key <span class='opt'>(optional)</span></label>"
    "<div class='pw-wrap'>"
    "<input type='text' id='k' name='psk' maxlength='47' placeholder='Base64, 44 characters'>"
    "<button type='button' class='pw-toggle' onclick='genKey()' title='Generate'>&#127922;</button>"
    "</div>"
    "<div class='hint'>Needed for the ESPHome API. Generate one here and paste "
    "the same value into Home Assistant, or leave empty to set it later.</div>"
    ...
    "var b='';for(var i=0;i<32;i++)b+=String.fromCharCode(a[i]);"
    "document.getElementById('k').value=btoa(b);}"
